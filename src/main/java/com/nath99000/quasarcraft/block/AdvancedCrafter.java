...
public class AdvancedCrafter extends Block
{
    @SideOnly(Side.CLIENT)
    public IIcon field_150035_a;
    @SideOnly(Side.CLIENT)
    public IIcon field_150034_b;
    public static final String __OBFID = "CL_00000221";

    protected AdvancedCrafter()
    {
        super(Material.wood);
