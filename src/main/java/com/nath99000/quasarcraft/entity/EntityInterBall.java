...
public class EntityInterBall extends EntityFireball {
    int tick = 0;
    private static final String __OBFID = "CL_00001728";

    public EntityInterBall(World p_i1793_1_) {
        super(p_i1793_1_);
        this.setSize(0.3125F, 0.3125F);
    }

    public EntityInterBall(World p_i1794_1_, EntityLivingBase p_i1794_2_, double p_i1794_3_, double p_i1794_5_, double p_i1794_7_) {
    ...
    public EntityInterBall(World p_i1795_1_, double p_i1795_2_, double p_i1795_4_, double p_i1795_6_, double p_i1795_8_, double p_i1795_10_, double p_i1795_12_) {
