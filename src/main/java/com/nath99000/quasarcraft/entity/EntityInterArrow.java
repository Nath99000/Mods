...
public class EntityInterArrow extends Entity implements IProjectile{
    ...
    public EntityInterArrow(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityInterArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityInterArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityInterArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    EntityArrow arrow = new EntityArrow(super.worldObj);
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
        ...
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (flag)
            {
                ...
                p_70100_1_.addPotionEffect(new PotionEffect(Potion.wither.id, 20 * b0, 0));
                this.setDead();
            }
        }
    }
    public void onCollideWithEntity(Entity par1)
    {
        byte b0 = 40;
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
